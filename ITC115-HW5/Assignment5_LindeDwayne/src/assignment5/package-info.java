...
case1: QUARTERS: 
Quarters counted first. If centsQ >= 25, then quarters = centsQ/25.
Go into the if else loops to break down the quarters remainders into dimes, nickels, and pennies. 
break

case2: DIMES: 
Dimes counted next. If centsD < 25 yet >= 10, then dimes = centsD/10.
Go into the if else loops to break down the dimes remainders into nickels and pennies. 
break

case3: NICKELS: 
Nickels counted next. If centsN < 10 yet >= 5, then nickels = centsN/5.
Go into the if else loops to break down the nickels remainders into pennies. 
break

case4: PENNIES.
Pennies counted next. centsP = centsN<5.
break

default: OUT OF BOUNDS.
If cents > 99 or < 0, print "OUT OF BOUNDS". 
break 
